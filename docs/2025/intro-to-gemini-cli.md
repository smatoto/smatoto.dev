---
id: W3
title: "Bringing AI to Your Command Line: Hands-on with Gemini CLI"
summary: "A hands-on workshop introducing Gemini CLI: Google's open-source AI tool for the terminal: covering installation, authentication, core features, and real-world usage patterns for developers who live in the command line."
type: Workshop
category: AI
status: Delivered
level: Intermediate
...
events:
  - name: "DevFest Manila 2025"
    organizer: "GDG Manila"
    date: 2025-11-15
    location: "Accenture People Hub, Taguig, Philippines"
    attendees: 218
    url:
      name: "Event Page"
  ...
  - name: "DevFest Cebu 2025"
    organizer: "GDG Cebu"
    date: 2025-11-30
    location: "Golden Peak Hotel, Cebu City, Philippines"
    attendees: 90
    url:
      name: "Event Page"
...
resources:
  github:
    ...
    link: "https://goo.gle/gemini-cli-hands-on"
  blog:
    name: "Blog Post"
    link: ""
  recording:
